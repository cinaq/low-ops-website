...
import backupsImage from '@/assets/backups.png';
...
export const metadata = {
  ...
  description:
    'Leverage our battle-tested expertise from building 10+ enterprise platforms.',
};
...
export const problemsWeSolve = [
  {
    ...
    description:
      'Are mounting operational tasks for your private cloud or on-premise applications straining your IT resources and budget? Many businesses struggle with the complexity and expense of traditional infrastructure management.',
    imagePath: monitoringImage,
    icon: Lightning01({}),
    solutions: [
  ...
  },
  {
    ...
    description:
      'Is the time taken to deploy and manage applications hindering your ability to innovate and respond to market changes quickly? Developer productivity often gets bogged down by infrastructure hurdles.',
    imagePath: backupsImage,
    icon: Shield01({}),
    solutions: [
  ...
  },
  {
    ...
    description:
      'Finding and retaining specialized DevOps or platform engineering talent can be a significant challenge and expense for growing businesses. This often leaves existing teams stretched thin.',
